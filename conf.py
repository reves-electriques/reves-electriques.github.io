...
BLOG_AUTHOR = "Job Done"  # (translatable)
BLOG_TITLE = "Des rêves électriques"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://reves-electriques.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://reves-electriques.github.io/"
BLOG_EMAIL = "jobdone.workeasy@gmail.com"
BLOG_DESCRIPTION = "Le blog d'un programmeur espagnol."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "des-reves-electriques"
